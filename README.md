...
```javascript
hoursInYear = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/time-hours-in-year@v0.0.9-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/time-hours-in-year@v0.0.9-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/time-hours-in-year/actions/workflows/test.yml/badge.svg?branch=v0.0.9
[test-url]: https://github.com/stdlib-js/time-hours-in-year/actions/workflows/test.yml?query=branch:v0.0.9
